...
//mongodb connection
mongoose.connect(
  `mongodb://${config.MONGODB_USERNAME}:${config.MONGODB_PASSWORD}@ec2-18-142-178-249.ap-southeast-1.compute.amazonaws.com:27017/${config.MONGODB_DB_NAME}?authSource=admin`, // YOUR_MONGODB_CONNECTION_STRING
  {
